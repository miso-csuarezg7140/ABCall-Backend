...
class ApiUtilsTest {
    ...
    void buildResponseShouldReturnResponseWithPaginationWhenStatusCodeIsOk() {
        ...
        ResponseServiceDto result = apiUtils.buildResponse(HttpResponseCodes.OK.getCode(), HttpResponseMessages.OK.getMessage(), response, pagination);
        ...
        Map<String, Object> expectedData = Map.of(Constants.RESPONSE_VALUE, response, Constants.PAGINATION_VALUE, pagination);
    ...
    void buildResponseShouldReturnResponseWithoutPaginationWhenStatusCodeIsNotOk() {
        ...
        ResponseServiceDto result = apiUtils.buildResponse(HttpResponseCodes.BAD_REQUEST.getCode(), HttpResponseMessages.BAD_REQUEST.getMessage(), response, null);
    ...
    void buildResponseShouldReturnResponseWithGivenData() {
        ...
        ResponseServiceDto result = apiUtils.buildResponse(HttpResponseCodes.OK.getCode(), HttpResponseMessages.OK.getMessage(), response);
