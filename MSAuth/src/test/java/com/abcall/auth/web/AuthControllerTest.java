...
class AuthControllerTest {
    ...
    void loginShouldReturnBadRequestWhenBindingResultHasErrors() {
        ...
        ResponseServiceDto responseDto = new ResponseServiceDto(HttpResponseCodes.BAD_REQUEST.getCode(), HttpResponseMessages.BAD_REQUEST.getMessage(), "error");
    ...
    void loginShouldReturnResponseFromAuthServiceWhenBindingResultHasNoErrors() {
        ...
        when(authService.authenticateUser("username", "password", "userType"))
